...
<%	
	if(session.getAttribute("estado_sesion") == TipoSession.NO_LOGIN){
		List<String> Ususarios = (List<String>)request.getAttribute("ListaUsuarios");
		for (String i : Ususarios) {
	%>
						...
						<div class="btn-group">
							...
							<div class="dropdown-menu dropdown-menu-right">
								<button class="dropdown-item"
									onclick="window.location.href = 'Perfil?nick=<%=java.net.URLEncoder.encode(i, "UTF-8") %>';"
									type="button">Ver Perfil</button>
							</div>
						</div>
					</div>
				</div>
