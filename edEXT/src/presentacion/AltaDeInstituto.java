...
public class AltaDeInstituto extends JInternalFrame{
	private JTextField textNombre;
	public AltaDeInstituto() {
	...
	private void checkAndCreate(ActionEvent argo) {
		if(checkSwing()) {
			try {
				interfaceCurso ICurso = Fabrica.getInstancia().getICurso();
				ICurso.registrarInstituto(textNombre.getText());
				JOptionPane.showMessageDialog(this, "El Instituto se ha creado con Exito", "Registrar Instituto",
						JOptionPane.INFORMATION_MESSAGE);
			}catch(InstitutoRepetidoExcep e) {
				JOptionPane.showMessageDialog(this, e.getMessage(), "Registrar Instituto", JOptionPane.ERROR_MESSAGE);
			}
		}
	}
}
